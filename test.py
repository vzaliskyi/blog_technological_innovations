    ...
    def setUp(self):
        ...
        db.session.add_all([Category(name='Смартфони'),
                            ...
                            Post(category_id=1, user_id=1, title='Назва блогу 1',
                                content='Text text text text text text text text'),
...
class TestsCRUD(BaseTestCase):    
    ...
    def test1_create_post(self):
        ...
        response = self.client.post('/post/create',
                                        data={'category': 2,
                                              'title': 'New post',
                                              'content': 'restsdffffffffffffgggdfghgfgh'
                                              }, follow_redirects=True)
    ...
    def test2_view_post(self):
        for i in range(1, 6):
            ...
            self.assertTrue('Text text text text text text text text' in response.get_data(as_text=True))
    ...
    def test3_update_post(self):
        for i in range(1, 6):
            ...
            response = self.client.post(f'post/{i}/update',
                ...
                'category': 1,
                'title':'Updated post',
                'content':'Text text text text text text text text'}, follow_redirects=True)
    ...
    def test5_auth_create_post_succesfull(self):
        with self.client:
            ...
            response = self.client.post('/post/create',
                                        data={'category': 1,
                                              'title': 'Post_tester22',
                                              'content': 'папаапsdfh gchkfyukhklvmccgfsdfbxcvbfhghf'
                                              }, follow_redirects=True)
            self.assert200(response)
    ...
    def test6_auth_create_post_unsuccesfull(self):
        with self.client:
            ...
            self.assertTrue('Заголовок повинен бути довжиною від 5 до 100 симолів!'
                            in response.get_data(as_text=True))

            self.assertTrue('Текст повинен бути довжиною від 15 символів'
                            in response.get_data(as_text=True))
        ...
        with self.client:
            ...
            for i in range(1, 6):
                ...
                response = self.client.post(f'post/{i}/update',
                                            ...
                                            'category': 1,
                                            'title':f'Upda',
                                            'content':'Text'}, follow_redirects=True)
    ...
    def test10_auth_delete(self):
         ...
         with self.client:
            ...
            for i in range(5, 0, -1):
                ...
                response = self.client.get(f'/post/{i}/delete', follow_redirects=True)
